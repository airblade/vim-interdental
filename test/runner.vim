" Runner for Vimscript tests.
"
" Installation: place this file in your plugin's test/ directory.
"
" Usage:
"
" - Invoke this file via `./test`.  Don't call it directly.
" - To write debug output: `call Log('helpful info')`
"
